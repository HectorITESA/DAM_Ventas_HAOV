...
namespace Blazor.WEB.Repositories
{
        ...
        public class Repositor : IRepository
        {
            ...
            public async Task<HttpResponseWrapper<T>> Get<T>(string url)
            {
                ...
                if(responseHttp.IsSuccessStatusCode)
                {
                    ...
                    return new
                        HttpResponseWrapper<T>(response, false, responseHttp);
                }
                return new
                    HttpResponseWrapper<T>(default, true, responseHttp);
            }
            public async Task<HttpResponseWrapper<object>> Post<T>(string url, T model)
            {
                ...
                return new
                    HttpResponseWrapper<object>(null, !responseHttp.IsSuccessStatusCode,responseHttp);
